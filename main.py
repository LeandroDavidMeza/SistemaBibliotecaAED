...
from logica import CAMPOS_LIBROS, CAMPOS_USUARIOS, CAMPOS_PRESTAMOS, crear_libro, crear_usuario, registrar_prestamo_sistema, registrar_devolucion_sistema
...
def menu_principal():
    ...
    while not salir:
        ...
        if opcion == '1':
            ...
            if sub_opcion == '1':
                # Vamos a llamar a la función que está en lógica, con los datos necesarios.
                registrar_prestamo_sistema(usuarios, libros, prestamos)
            elif sub_opcion == '2':
                #vamos a llamar a la segunda función.
                registrar_devolucion_sistema(libros, prestamos)
            elif sub_opcion == '3':
                listar_prestamos_sistema(prestamos)
            else: 
                print("Opción no válida.")
